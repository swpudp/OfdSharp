...
namespace OfdSharp.Core.CustomTags
{
    /// <summary>
    /// 自定义标引集合
    /// 外部系统或用户可以添加自定义标记和信息，从而达到与其他系统、数据进行交互的目的并扩展应用。
    /// 一个文档可以带有多个自定义标引。
    ...
    /// </summary>
    public class CustomTagCollect : OfdElement
    {
        public CustomTagCollect(XmlDocument xmlDocument) : base(xmlDocument, "CustomTags")
        {
        }
