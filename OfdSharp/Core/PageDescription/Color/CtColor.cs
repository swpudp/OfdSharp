using OfdSharp.Core.PageDescription.Pattern;
...
namespace OfdSharp.Core.PageDescription.Color
{
    ...
    public class CtColor
    {
        ...
        /// 轴向渐变,复杂颜色的一种。
        /// </summary>
        public CtAxialShd AxialShd { get; set; }

        /// <summary>
        /// 径向渐变,复杂颜色的一种。
        /// </summary>
        public CtRadialShd RadialShd { get; set; }

        /// <summary>
        /// 高洛德渐变,复杂颜色的一种。
        /// </summary>
        public CtRadialShd GouraudShd { get; set; }

        /// <summary>
        /// 格构高洛德渐变,复杂颜色的一种。
        /// </summary>
        public CtRadialShd LaGouraudShd { get; set; }
    }
}
