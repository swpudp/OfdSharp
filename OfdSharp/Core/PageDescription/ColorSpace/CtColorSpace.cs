...
namespace OfdSharp.Core.PageDescription.ColorSpace
{
    ...
    /// 通过设置索引值进行引用。
    /// </summary>
    public class CtColorSpace : OfdElement
    {
        public CtColorSpace(XmlDocument xmlDocument) : base(xmlDocument, "ColorSpace")
        {
        }
        ...
        /// 每个颜色通道使用的位数
        /// </summary>
        public BitsPerComponent BitsPerComponent { get; set; }
